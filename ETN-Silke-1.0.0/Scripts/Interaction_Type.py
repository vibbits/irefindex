...
if __name__ == "__main__":
	...
	with open(irefIndexFile, 'r',encoding="utf-8") as ppiFile:
		...
		for row in csvreader:
			...
			edgeType = row[52]
			if 'complex' in entryType and expansionModel == 'bipartite' and edgeType == 'C' and 'Homo sapiens' in taxb and 'corum' in source:
	...
	ax.set(ylim=(0,2000),xlabel="Interaction type",ylabel="Number of occurences",
	title="Number of occurences of each \ninteraction type - corum")
