...
if __name__ == "__main__":
	...
	# Read in the file, filter on edgeType and organism
	...
	with open(irefIndexFile, 'r',encoding="utf-8") as ppiFile:
		...
		for row in csvreader:
			...
			source = row[12]
			edgeType = row[52]
			if edgeType == 'Y' and "Mycoplasma pneumoniae M129" in taxa:
	...
	matrix_labels.to_csv('Overlap_sources_matrix_Y_Mycoplasma-pneumoniae-M129.csv',index=True,sep='\t')
	with open('Overlap_sources_matrix_Y_Mycoplasma-pneumoniae-M129.csv',mode='a') as csv_file:
