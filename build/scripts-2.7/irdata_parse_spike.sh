...
#it is assumed that all records in the spike file refer to protein-protein interactions
#it is not possible to check for these (as done in the below commented code) because spike
