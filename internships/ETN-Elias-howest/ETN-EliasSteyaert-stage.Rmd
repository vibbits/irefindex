...
- This was fixed with making an ansible.cfg file with the code “remote_tmp = /mnt/disks/data 
- Investigating the error: "sh: 1: Syntax error: Unterminated quoted string" 
