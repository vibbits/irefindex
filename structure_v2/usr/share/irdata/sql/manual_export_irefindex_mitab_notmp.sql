...
create table tmp_interactions as
...
create table tmp_identifiers as
...
create table tmp_participants as
...
create table tmp_assignments as
    select A.*, score
...
create table tmp_confidence as
...
create table tmp_named_interactions as
    select I.*,
...
create table tmp_interaction_experiments as
    select I.*,
...
--\copy tmp_interaction_experiments to '<directory>/interaction_exp1'
create table tmp_interactor_experiments as
    select I.*,
...
--\copy tmp_interactor_experiments to '<directory>/interactor_exp2'
-- Collect all participant-, interactor- and interaction-related information.

create table tmp_mitab_interactions as
    select I.*,
...
--\copy tmp_mitab_interactions to '<directory>/int_mitab'
-- Combine with ROG-related information to produce MITAB-appropriate records.

create table tmp_mitab_all as
    select
...
create table tmp_interaction_taxids as
...
create table tmp_mitab_all_organisms as
