...
for THISFILE in $FILENAMES; do
	...
	#sed 's/psi-mi:MI:0326(protein)/psi-mi:\"MI:0326\"(protein)/g' $THISFILE > tmp
    awk 'BEGIN {FS="\t";}{OFS="\t";}{if ($21 == "psi-mi:MI:0326(protein)"  && $22 == "psi-mi:MI:0326(protein)"){ $9 = "psi-mi:\"MI:0445\"(literature database)";$21= "psi-mi:\"MI:0326\"(protein)" ; $22 = "psi-mi:\"MI:0326\"(protein)";$13= "psi-mi:\"MI:0461\"(interaction database)";print $0;}}' < "$THISFILE" > tmp
